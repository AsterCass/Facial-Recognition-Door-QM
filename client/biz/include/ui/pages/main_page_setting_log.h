#ifndef MAIN_PAGE_SETTING_LOG_H
#define MAIN_PAGE_SETTING_LOG_H
...
class MainSettingLog final : public QWidget {
public:
    explicit MainSettingLog(QWidget *parent = nullptr);

    ~MainSettingLog() override;
